    ...
    <div class="w-full p-3">
      ...
      <div
        class="group relative flex items-center rounded-2xl border border-white/20 bg-white/10 p-4
          ...
          hover:border-amber-300/50 hover:shadow-2xl hover:shadow-amber-500/10"
      >
        <div
        ...
        >
          <div
            class="h-24 w-24 overflow-hidden rounded-full border-2 border-amber-300/50 shadow-lg"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
            ...
            <div
              v-else
              class="flex h-full w-full items-center justify-center bg-white/10 text-white/40"
            >
              <UserRound :size="40" />
            </div>
          </div>
          <span class="mt-1 h-1 w-6 rounded-full bg-amber-300"></span>
        ...
        <div class="flex h-full min-h-36 flex-1 flex-col justify-between pl-4">
          ...
          <div class="mt-4 flex items-center justify-end gap-2">
            <button
              class="rounded-full border border-amber-300/40 bg-amber-400/80 px-5 py-1.5 text-xs
                font-bold text-slate-900 shadow-lg shadow-amber-500/20 transition-all
                hover:bg-amber-300"
              @click="openModal"
            >
